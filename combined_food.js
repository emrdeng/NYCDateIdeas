...
console.log(arrayOfCombinedFoodKeys);
...
console.log(cuisineArrayListForUser);
...
console.log(sortedCuisineNames);
...
//This will identify the key that correlates with the search result.
function getKeyByValue(object, value) {
  var x = Object.keys(object)
  return x.find(function(key) {
    return object[key].label === value
  });
}
console.log(getKeyByValue(cuisineNames, "Chinese"));




//THESE ARE ALL THE COMBINED FOOD CODES THAT WILL RETURN: COFFEE, BAR, DESSERT:
//COFFEE WOULD BE 10642!!!
var extraChatTimeNames = {
  "Bars_Pubs":{
    "10640": {
      "count": "1140",
      "label": "Bar",
...
var arrayOfExtraBars = Object.keys(extraChatTimeNames.Bars_Pubs);
var arrayOfExtraDessert = Object.keys(extraChatTimeNames.Dessert);
var arrayOfCoffee = ["10642"];
var allBarDessertCoffeeArray = arrayOfExtraBars.concat(arrayOfExtraDessert, arrayOfCoffee);
console.log(arrayOfExtraBars);
console.log(arrayOfExtraDessert);
console.log(allBarDessertCoffeeArray);

var barString = arrayOfExtraBars.toString();
var dessertString = arrayOfExtraDessert.toString();
var allBarDessertCoffeeString = allBarDessertCoffeeArray.toString();
console.log(barString);
console.log(dessertString);
console.log(allBarDessertCoffeeString);
//TENDERLOIN EXCLUSION KEY IS 15565668
var neighborhood = {
"7102343": {
"count": "6",
"label": "Chelsea",
...
"15565659": {
"count": "0",
"label": "Randalls and Wards Islands",
"selected": false
},
"15565660": {
"count": "0",
...
"15565675": {
"count": "3",
"label": "Upper Manhattan (Uptown)",
"selected": false
},
"15565677": {
"count": "26",
"label": "Downtown Manhattan (Downtown)",
"selected": false
},
"20933769": {
"count": "0",
...
var arrayOfLocations = Object.keys(neighborhood);
console.log(arrayOfLocations);



//FIGURING OUT THAT WHICH LOCATION IS THE RIGHT LOCATION TO USE:

neighborhoodInfo = [
{location_id: '7102352', name: 'Midtown'},
{location_id: '7212972', name: 'NoMad'},
{location_id: '15565647', name: 'Koreatown'},
]

function findTheRightLocation(x){
  if(x.location_id !="60763" && x.location_id !="15565668" && x.location_id !="7102352"){
    return true;
  }
}

console.log(neighborhoodInfo.findIndex(findTheRightLocation));
